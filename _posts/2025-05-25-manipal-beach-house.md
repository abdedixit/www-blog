...
{% include image_full.html imageurl="/images/posts/manipal2024/manipal_BeachHouse.JPG" %}
...
I have learnt that a cosmic perspective could often help put things into the widest context. In the brilliant words of Carl Sagan (<a href="https://www.planetary.org/worlds/pale-blue-dot" target="_blank">Pale Blue Dot</a>, 1994), *“Our posturings, our imagined self-importance, the delusion that we have some privileged position in the Universe, are challenged by this point of pale light. Our planet is a lonely speck in the great enveloping cosmic dark. In our obscurity, in all this vastness, there is no hint that help will come from elsewhere to save us from ourselves.”* In my own not-so-dignified words, the Universe doesn’t give a rat’s (or perhaps in this case, a human’s) about the survival of humanity.
